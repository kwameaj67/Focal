...
final class OrientationTests: XCTestCase {
    ...
    func testIsLandscape() {
        XCTAssertTrue(UIDeviceOrientation.landscapeLeft.fcIsLandscape)
        XCTAssertTrue(UIDeviceOrientation.landscapeRight.fcIsLandscape)
        XCTAssertFalse(UIDeviceOrientation.portrait.fcIsLandscape)
        XCTAssertFalse(UIDeviceOrientation.faceUp.fcIsLandscape)
    }
    ...
    func testCaptureOrientationSwapsLandscape() {
        ...
        XCTAssertEqual(UIDeviceOrientation.landscapeLeft.fcCaptureRotationAngle, 0)
        XCTAssertEqual(UIDeviceOrientation.landscapeRight.fcCaptureRotationAngle, 180)
        XCTAssertEqual(UIDeviceOrientation.portrait.fcCaptureRotationAngle, 90)
        XCTAssertEqual(UIDeviceOrientation.portraitUpsideDown.fcCaptureRotationAngle, 270)
    }

    func testCaptureOrientationDefaultsToPortrait() {
        // Ambiguous physical orientations should not tilt the capture.
        XCTAssertEqual(UIDeviceOrientation.faceUp.fcCaptureRotationAngle, 90)
        XCTAssertEqual(UIDeviceOrientation.faceDown.fcCaptureRotationAngle, 90)
        XCTAssertEqual(UIDeviceOrientation.unknown.fcCaptureRotationAngle, 90)
    }
}
