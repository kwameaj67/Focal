...
package struct CategoryScrollBar: View {
    ...
    package let categories: [CSCategory]
    @Binding package var selected: CSCategory?
    ...
    private func pill(for category: CSCategory) -> some View {
    ...
    private func select(_ category: CSCategory, proxy: ScrollViewProxy) {
    ...
    private func center(on category: CSCategory?, proxy: ScrollViewProxy, animated: Bool) {
...
#Preview("Category bar") {
    @Previewable @State var selected: CSCategory? = CSCategory("Profile")
    ZStack {
        Color.black
        CategoryScrollBar(
            categories: [
...
#Preview("Category bar — single option") {
    ...
    ZStack {
        Color.black
        CategoryScrollBar(categories: [CSCategory("Profile")], selected: $selected)
    }
    .ignoresSafeArea()
}
