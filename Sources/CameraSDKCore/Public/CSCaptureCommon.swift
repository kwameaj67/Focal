...
//  with their own targets, in CSPhotoResult / CSVideoResult.
//

import Foundation

/// Where a piece of media came from.
public enum CSCaptureSource: Sendable {
...
public enum CSFinishReason: Sendable {
