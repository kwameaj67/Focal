...
public enum FCFlashMode: Sendable {
    case auto
    case on
    case off
...
public struct FCCameraConfig {
    ...
    public var defaultFlashMode: FCFlashMode
    ...
    public init(
        ...
        defaultFlashMode: FCFlashMode = .auto,
