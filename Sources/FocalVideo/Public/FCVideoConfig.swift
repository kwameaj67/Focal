...
public struct FCVideoConfig {
    ...
    public var presetByCategoryID: [String: FCVideoQuality]

    /// Quality preset used for categories not listed in `presetByCategoryID`.
    public var defaultPreset: FCVideoQuality
    ...
    public var defaultFrameRate: FCFrameRate
    ...
    public init(
        ...
        presetByCategoryID: [String: FCVideoQuality] = [:],
        defaultPreset: FCVideoQuality = .hd1080,
        defaultFrameRate: FCFrameRate = .fps60,
    ...
    var initialCategory: FCCategory? {
    ...
    func preset(for category: FCCategory?) -> FCVideoQuality {
...
public enum FCVideoQuality: Sendable {
    /// 1920×1080.
    case hd1080
    /// 1280×720.
    case hd720
