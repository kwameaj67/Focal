...
struct CapturedPhotoItem: Identifiable {
    ...
    init(data: Data, image: UIImage, category: CSCategory?) {
        self.data = data
...
struct CapturedGalleryPreview: View {
    ...
    @ViewBuilder
    private func categoryLabel(_ category: CSCategory?) -> some View {
