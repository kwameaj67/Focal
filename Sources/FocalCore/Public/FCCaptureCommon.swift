...
//  with their own targets, in FCPhotoResult / FCVideoResult.
//

import Foundation

/// Where a piece of media came from.
public enum FCCaptureSource: Sendable {
...
public enum FCFinishReason: Sendable {
